...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                  <center data-parsed="" style="background:#000;">
                    <a href="{{ URL::to('/') }}" align="center" class="text-center">
                        @if(getcong('site_logo'))
                            <img src="{{ URL::asset('upload/'.getcong('site_logo')) }}" class="swu-logo" alt="Logo">
                        @else
...
<th class="expander"></th>
      ...
      <table>
        <tr>
          <th>
                <h5>Hi, <?php echo $fname.' '.$lname ?></h5>
                  <p>Your order <?php echo $order?> Processing, order is placed within 2-3 days.</p>
                  <br>
      ...
      <table>
        <tr>
          <th>
                  <p class="text-center footercopy">&#xA9; {{getcong('site_copyright')}}</p>
                </th>
<th class="expander"></th>
        </tr>
      </table>
