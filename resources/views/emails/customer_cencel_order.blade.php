...
<body>
    <div class="invoice-box" id="print_invoice">
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="font-size:14px; font-weight:bold">Address : <?php echo $customer_address ?>, <?php echo $customer_city ?>, <?php echo $customer_state ?>, <?php echo $customer_zipcode ?></span>
                            </td> 
                            
                        <td>
                                <h3 class="title">Shipping Address</h3>
                                 @if(!empty($ship_fname && $ship_lname && $ship_mobile && $ship_email && $ship_address && $ship_city && $ship_state && $ship_zipcode))
                                 ...
                                 <span style="font-size:14px; font-weight:bold">Address : <?php echo $ship_address ?>, <?php echo $ship_city ?>, <?php echo $ship_state ?>, <?php echo $ship_zipcode ?></span>
                                @else 
                                <span style="font-size:14px; font-weight:bold">Name : <?php echo $customer_name.' '.$customer_lname ?><br></span>
                                <span style="font-size:14px; font-weight:bold">Mobile : <?php echo $customer_mobile ?><br></span>
                                <span style="font-size:14px; font-weight:bold">Email : <?php echo $customer_email ?><br></span>
            ...
            $order_mail= DB::table('order')
               ...
               ->where('order.order_id','=',$order_id)->get();
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Discount</td>
                    <td>$@if(!empty($discount)) {{$discount}} @else 0 @endif</td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <?php $handlingcharges = \App\HandlingCharges::where('id',1)->pluck('charges'); ?>
                    <td>{{@$handlingcharges[0]}}% handling fees</td>
                    <td>$ @if(!empty($discount)){{ $handling_charge=($shipping_fees+$total)*@$handlingcharges[0]/100}}  @else {{ $handling_charge=($shipping_fees+$total)*@$handlingcharges[0]/100}} @endif</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td>Grand Total</td>
                    <td>$<?php echo $handling_charge+$total+$shipping_fees-$discount;?></td>
                </tr>
          ...
          <table>
             <tr>
                 <td><strong>Your Order has been Canceled! </strong></td>
               
            </tr>
            <tr>
                 <td>your blocked amount will automatically be added to your balance in 3-4 working days after verification by concerned team</td>
