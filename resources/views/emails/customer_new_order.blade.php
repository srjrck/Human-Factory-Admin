               ...
               ->where('order.order_id','=',$order_id)->get();
                ...
                ?>
                    <tr class="item"> 
                        ...
                        <td> {{$products->product_iv}}</td>
                        <td><i class="fa fa-inr"></i> {{$products->product_price}}</td>
                    </tr>                    
                <?php $i++; } ?>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>Discount</td>
                    <td><i class="fa fa-inr"></i> @if(!empty($discount)) {{$discount}} @else 0 @endif</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td>Total IV</td>
                    <td><i class="fa fa-inr"></i> {{ $total_iv }}</td>
                </tr>
                <!--<tr>
                    <td></td>
                    <td></td>
                    <td>Shipping Fees</td>
                    <td><i class="fa fa-rupee-sign"></i> {{$shipping_fees}}</td>
                </tr>-->
              <!--  <tr>
                    <td></td>
                    <td></td>
                    ...
                    <td><i class="fas fa-rupee-sign"></i> @if(!empty($discount)){{ $handling_charge=($shipping_fees+$total)*@$handlingcharges[0]/100}}  @else {{ $handling_charge=($shipping_fees+$total)*@$handlingcharges[0]/100}} @endif</td>
                </tr>-->
                <tr>
                    <td></td>
                    <td></td>
                    <td>Grand Total</td>
                    <td><i class="fa fa-inr"></i> <?php echo $handling_charge+$total+$shipping_fees-$discount;?></td>
                </tr>
