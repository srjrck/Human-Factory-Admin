...
<body>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('SaveTelecom')}}" enctype="multipart/form-data" method="post" id="EditForm" name="EditForm" novalidate="novalidate">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{$row->system}}" class="form-control" id="system" name="system" placeholder="System">
                    </div> 
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
  ...
  <script src="{{ asset('public/Admin')}}/assets/validation/Telecom.js"></script> 
</body>
</html>
