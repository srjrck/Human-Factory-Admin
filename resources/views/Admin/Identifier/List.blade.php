      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Identifier List</li>
          </ol>
        </div>
      </div>     
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <h5 class="card-title">Identifier List</h5>
                </div>
                <div class="col-sm-6">
                  <a href="{{route('AddIdentifier')}}">
                  ...
                  <tbody>
                    ...
                    ?>  
                      <tr>
                        ...
                        <td>
                          <a href="<?=route('EditIdentifier',array('ID'=>base64_encode($row->id)))?>">
                            <button class="btn btn-success"> <i class="fa fa-edit"></i> </button>
                          </a>
                          <a href="<?=route('DeleteIdentifier',array('ID'=>base64_encode($row->id)))?>" onclick = "if (! confirm('Are you sure?')) { return false; }">
