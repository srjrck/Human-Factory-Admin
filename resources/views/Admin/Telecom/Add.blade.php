      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('Telecom')}}">Telecom</a></li>
        ...
        <div class="col-lg-12 mx-auto">
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('InsertTelecom')}}" enctype="multipart/form-data" method="post" id="Add" name="Add" novalidate="novalidate">
